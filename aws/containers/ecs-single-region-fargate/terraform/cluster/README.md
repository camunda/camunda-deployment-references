...
| <a name="input_orchestration_cluster_s3_bucket_force_delete"></a> [orchestration\_cluster\_s3\_bucket\_force\_delete](#input\_orchestration\_cluster\_s3\_bucket\_force\_delete) | Whether to force destroy the S3 bucket used by the orchestration cluster even if it contains objects. Set to true for testing CI environments. | `bool` | `false` | no |
