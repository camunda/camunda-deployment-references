...
resource "aws_iam_role" "ecs_task_role" {
  name = "${var.prefix}-camunda-hub-task-role"
...
resource "aws_iam_policy" "ecs_exec_policy" {
  name = "${var.prefix}-camunda-hub-exec-policy"
...
# CloudWatch Logs policy for Camunda Hub
resource "aws_iam_policy" "camunda_hub_logs_policy" {
  name = "${var.prefix}-camunda-hub-logs-policy"
...
resource "aws_iam_role_policy_attachment" "camunda_hub_logs_policy_attachment" {
  role       = aws_iam_role.ecs_task_role.name
  policy_arn = aws_iam_policy.camunda_hub_logs_policy.arn
}
