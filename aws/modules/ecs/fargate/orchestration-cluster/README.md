...
| <a name="input_enable_alb_http_9600_listener_rule"></a> [enable\_alb\_http\_9600\_listener\_rule](#input\_enable\_alb\_http\_9600\_listener\_rule) | Whether to create the ALB listener rule on port 9600 (must be a known boolean at plan time) | `bool` | `true` | no |
