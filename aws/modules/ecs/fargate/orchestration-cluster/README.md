...
| <a name="input_image"></a> [image](#input\_image) | The container image to use for the Camunda orchestration cluster | `string` | `"camunda/camunda:8.9.16"` | no |
...
| <a name="input_restore_container_image"></a> [restore\_container\_image](#input\_restore\_container\_image) | Container image for the restore init container. Required when restore\_enabled is true. | `string` | `"camunda/camunda:8.9.16"` | no |
