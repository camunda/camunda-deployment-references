...
resource "aws_iam_role" "ecs_task_role" {
  name = "${var.prefix}-management-identity-task-role"
...
resource "aws_iam_policy" "ecs_exec_policy" {
  name = "${var.prefix}-management-identity-exec-policy"
...
# CloudWatch Logs policy for management-identity
resource "aws_iam_policy" "management_identity_logs_policy" {
  name = "${var.prefix}-management-identity-logs-policy"
...
resource "aws_iam_role_policy_attachment" "management_identity_logs_policy_attachment" {
  role       = aws_iam_role.ecs_task_role.name
  policy_arn = aws_iam_policy.management_identity_logs_policy.arn
}
