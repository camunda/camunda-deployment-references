...
| <a name="input_accepter_region"></a> [accepter\_region](#input\_accepter\_region) | AWS region containing the Transit Gateway that accepts the peering request | `string` | n/a | yes |
...
| <a name="input_owner_region"></a> [owner\_region](#input\_owner\_region) | AWS region containing the Transit Gateway that initiates the peering request | `string` | n/a | yes |
