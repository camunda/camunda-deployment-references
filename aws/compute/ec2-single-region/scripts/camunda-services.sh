...
transfer_file "${SCRIPT_DIR}/../configs/camunda.service" "${MNT_DIR}" camunda.service
transfer_file "${SCRIPT_DIR}/../configs/connectors.service" "${MNT_DIR}" connectors.service
