...
| [aws_route_table_association.pods_region_0](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table_association) | resource |
| [aws_route_table_association.pods_region_1](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table_association) | resource |
| [aws_route_table_association.pods_region_2](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table_association) | resource |
| [aws_route_table_association.pods_region_3](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/route_table_association) | resource |
| [aws_subnet.pods_region_0](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
| [aws_subnet.pods_region_1](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
| [aws_subnet.pods_region_2](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
| [aws_subnet.pods_region_3](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/subnet) | resource |
| [aws_vpc_ipv4_cidr_block_association.pods_region_0](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_ipv4_cidr_block_association) | resource |
| [aws_vpc_ipv4_cidr_block_association.pods_region_1](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_ipv4_cidr_block_association) | resource |
| [aws_vpc_ipv4_cidr_block_association.pods_region_2](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_ipv4_cidr_block_association) | resource |
| [aws_vpc_ipv4_cidr_block_association.pods_region_3](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/vpc_ipv4_cidr_block_association) | resource |
...
| <a name="input_regions"></a> [regions](#input\_regions) | Ordered list of region slots. Index 0 is region slot 0, index 1 is region<br/>slot 1, and so on. The list length is immutable for the lifetime of the<br/>Camunda cluster because it drives the Zeebe broker node ID stride.<br/><br/>None of `vpc_cidr_block`, `service_cidr_block` and `pod_cidr_block` may<br/>overlap, within a region or across regions: Submariner is deployed without<br/>Globalnet, so every cluster CIDR it learns has to identify exactly one<br/>cluster, and Transit Gateway cannot route duplicate prefixes either.<br/><br/>`pod_cidr_block` is attached to the VPC as a SECONDARY CIDR and carries the<br/>pods only, through VPC CNI custom networking. Keeping pods out of the<br/>routed node range is what makes Submariner work on EKS; see<br/>pod-networking.tf and ../../README.md, section "Pod networking".<br/><br/>`short_name` is used to suffix cluster and resource names and must be a<br/>valid DNS label. | <pre>list(object({<br/>    region             = string<br/>    short_name         = string<br/>    vpc_cidr_block     = string<br/>    service_cidr_block = string<br/>    pod_cidr_block     = string<br/>  }))</pre> | <pre>[<br/>  {<br/>    "pod_cidr_block": "100.64.0.0/16",<br/>    "region": "eu-west-2",<br/>    "service_cidr_block": "10.190.0.0/16",<br/>    "short_name": "london",<br/>    "vpc_cidr_block": "10.192.0.0/16"<br/>  },<br/>  {<br/>    "pod_cidr_block": "100.65.0.0/16",<br/>    "region": "eu-west-3",<br/>    "service_cidr_block": "10.200.0.0/16",<br/>    "short_name": "paris",<br/>    "vpc_cidr_block": "10.202.0.0/16"<br/>  },<br/>  {<br/>    "pod_cidr_block": "100.66.0.0/16",<br/>    "region": "eu-central-2",<br/>    "service_cidr_block": "10.210.0.0/16",<br/>    "short_name": "zurich",<br/>    "vpc_cidr_block": "10.212.0.0/16"<br/>  }<br/>]</pre> | no |
...
| <a name="output_all_cidr_blocks"></a> [all\_cidr\_blocks](#output\_all\_cidr\_blocks) | Every VPC, Kubernetes service and pod CIDR of the active regions, used to build database firewall rules |
...
| <a name="output_pod_cidr_blocks"></a> [pod\_cidr\_blocks](#output\_pod\_cidr\_blocks) | Pod CIDR block per region slot, i.e. the VPC secondary CIDR carrying the<br/>custom networking subnets.<br/><br/>This is what `subctl join --clustercidr` must be given: passing the VPC<br/>CIDR instead makes Submariner claim the whole routed range and collide with<br/>the Transit Gateway. See pod-networking.tf. |
| <a name="output_pod_subnet_ids"></a> [pod\_subnet\_ids](#output\_pod\_subnet\_ids) | Custom networking subnet IDs per region slot, one per availability zone, referenced by the ENIConfig objects |
