...
#                                                                             #
# Growth therefore means EXTENDING this list when a zone is activated, which   #
# is what ./activate-region.sh does and what TestMultiRegionActivateRegion     #
# exists to prove. It matches how the zone-aware documentation frames it:      #
# zones are added dynamically, rather than pre-declared and filled in.         #
#                                                                             #
