locals {
  ...
  camunda_database_operate    = "camunda_operate"    # Name of your camunda database for RDBMS secondary storage (Operate + Tasklist)
  ...
  camunda_operate_db_username    = "operate_db"    # This is the username that will be used for connection to the DB on Operate/Tasklist db
  ...
  camunda_operate_db_password    = "secretvalue%27" # Replace with a password that will be used for connection to the DB on Operate/Tasklist db
