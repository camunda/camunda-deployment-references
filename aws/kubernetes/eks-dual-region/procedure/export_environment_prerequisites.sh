...
export REGION_0=${REGION_0:-us-east-1}
export REGION_1=${REGION_1:-us-east-2}

# The names of your Kubernetes clusters in regions 0 and 1
# default based on the tutorial is the following
export CLUSTER_0=${CLUSTER_0:-cluster-us-east-1}
export CLUSTER_1=${CLUSTER_1:-cluster-us-east-2}
...
export CAMUNDA_NAMESPACE_0=${CAMUNDA_NAMESPACE_0:-camunda-us-east-1}
export CAMUNDA_NAMESPACE_1=${CAMUNDA_NAMESPACE_1:-camunda-us-east-2}
