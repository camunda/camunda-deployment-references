locals {
  eks_cluster_name   = "lars-quick-efs" # Change this to a name of your choice
  eks_cluster_region = "eu-central-1"   # Change this to your desired AWS region
  ...
  single_nat_gateway = "true" # Change this to true if you want a single NAT gateway (1 IP vs 3 IPs)
