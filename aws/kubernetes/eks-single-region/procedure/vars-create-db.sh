...
export AURORA_USERNAME="$(terraform console <<<local.aurora_master_username | tail -n 1 | jq -r)"
export AURORA_PASSWORD="$(terraform console <<<local.aurora_master_password | tail -n 1 | jq -r)"
