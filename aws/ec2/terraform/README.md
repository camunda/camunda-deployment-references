...
| <a name="module_vpc"></a> [vpc](#module\_vpc) | terraform-aws-modules/vpc/aws | v5.16.0 |
## Resources
...
| <a name="input_aws_instance_type"></a> [aws\_instance\_type](#input\_aws\_instance\_type) | The instance type to use for the EC2 instances | `string` | `"m6i.xlarge"` | no |
| <a name="input_aws_instance_type_bastion"></a> [aws\_instance\_type\_bastion](#input\_aws\_instance\_type\_bastion) | The instance type to use for the bastion host | `string` | `"t2.nano"` | no |
