...
transfer_file ../configs/prometheus.yaml "${MNT_DIR}/cloudwatch/" prometheus.yaml
transfer_file ../configs/amazon-cloudwatch-agent.json "${MNT_DIR}/cloudwatch/" amazon-cloudwatch-agent.json
