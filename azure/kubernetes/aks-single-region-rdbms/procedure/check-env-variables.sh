...
required_vars=("POSTGRES_MAJOR_VERSION" "DB_HOST" "DB_PORT" "DB_IDENTITY_NAME" "DB_IDENTITY_USERNAME" "DB_IDENTITY_PASSWORD" "DB_WEBMODELER_NAME" "DB_WEBMODELER_USERNAME" "DB_WEBMODELER_PASSWORD" "DB_ORCHESTRATION_NAME" "DB_ORCHESTRATION_USERNAME" "DB_ORCHESTRATION_PASSWORD")
