...
# The chart deliberately keeps the `web-modeler` resource names under Camunda Hub
# so an 8.9 release upgrades in place, so this service is not called `camunda-hub-*`.
