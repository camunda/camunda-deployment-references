...
| `openshift-version-cluster-0` | <p>Version of the OpenShift to install</p> | `false` | `4.22.5` |
| `openshift-version-cluster-1` | <p>Version of the OpenShift to install</p> | `false` | `4.22.5` |
