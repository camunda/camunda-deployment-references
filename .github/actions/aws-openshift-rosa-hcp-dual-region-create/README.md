...
| `openshift-version-cluster-1` | <p>Version of the OpenShift to install</p> | `false` | `4.18.16` |
| `openshift-version-cluster-2` | <p>Version of the OpenShift to install</p> | `false` | `4.18.16` |
