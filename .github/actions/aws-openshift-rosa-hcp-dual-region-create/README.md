...
| `openshift-version-cluster-0` | <p>Version of the OpenShift to install</p> | `false` | `4.22.1` |
| `openshift-version-cluster-1` | <p>Version of the OpenShift to install</p> | `false` | `4.22.1` |
