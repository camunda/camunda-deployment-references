...
| `openshift-version-cluster-0` | <p>Version of the OpenShift to install</p> | `false` | `4.21.16` |
| `openshift-version-cluster-1` | <p>Version of the OpenShift to install</p> | `false` | `4.21.16` |
