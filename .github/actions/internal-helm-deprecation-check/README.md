...
- uses: camunda/camunda-deployment-references/.github/actions/internal-helm-deprecation-check@main
  with:
    ...
    # unaffected. When the comment cannot be written the action emits
    # an `::error::` annotation and skips it; it never fails the job.
    #
    # Required: false
