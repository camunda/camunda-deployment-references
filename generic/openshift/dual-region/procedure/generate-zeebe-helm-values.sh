...
echo -e "\nPlease use the following to change the existing environment variable ZEEBE_BROKER_EXPORTERS_ELASTICSEARCHREGION0_ARGS_CONNECT_URL $target_text. It's part of the 'zeebe.env' path."
echo "- name: ZEEBE_BROKER_EXPORTERS_ELASTICSEARCHREGION0_ARGS_CONNECT_URL"
echo "  value: $elastic0"

export ZEEBE_BROKER_EXPORTERS_ELASTICSEARCHREGION0_ARGS_CONNECT_URL="$elastic0"

echo -e "\nPlease use the following to change the existing environment variable ZEEBE_BROKER_EXPORTERS_ELASTICSEARCHREGION1_ARGS_CONNECT_URL $target_text. It's part of the 'zeebe.env' path."
echo "- name: ZEEBE_BROKER_EXPORTERS_ELASTICSEARCHREGION1_ARGS_CONNECT_URL"
echo "  value: $elastic1"

export ZEEBE_BROKER_EXPORTERS_ELASTICSEARCHREGION1_ARGS_CONNECT_URL="$elastic1"
